...
export const MOCK_IDEA_BLOCKS: IdeaBlock[] = [
	{
		...
		aiSummary: "團隊目前同意先用生存優先順序來討論，不急著投票。共識是先釐清氧氣、水、通訊設備在不同情境下的重要性。",
		transcript: "我覺得我們先不要馬上排序，可以先確認大家是不是都把目標理解成回到母船，而不是在原地等待救援。",
		transcriptLineId: "t1",
		expanded: true,
		status: "ready"
	},
	{
		...
		aiSummary: "氧氣被視為最直接的生存限制。若沒有氧氣，其他資源無法發揮作用，因此多數成員傾向把氧氣放在最高優先級。",
	...
	},
	{
		...
		aiSummary: "星圖能幫助路線規劃，無線電能提供求援或確認方向。兩者的排序取決於團隊假設：如果母船位置已知，星圖較重要；如果位置不確定，通訊可能更重要。",
		transcript: "如果我們知道母船大概在哪，星圖可能比無線電重要；但如果完全不知道方向，無線電也許可以先確認位置。",
		transcriptLineId: "t3",
		hasCue: true,
