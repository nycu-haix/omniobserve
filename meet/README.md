...
- `4443/tcp` is exposed as an ICE TCP fallback for environments where the upstream cloud network blocks UDP before it reaches the VM. Keep `10000/udp` open whenever possible; TCP media is a fallback, not the preferred path.
