...
2) summary：針對 content 原本逐字稿的部分進行解釋說明，讓人能理解 content 的意思與其和題目任務的關係，但不要直接複製原文且必須保留說話者原本的主觀立場與人稱
...
[
  {{
    ...
    "summary": "針對 content 原本逐字稿的部分進行解釋說明，讓人能理解 content 的意思與其和題目任務的關係，但不要直接複製原文且必須保留說話者原本的主觀立場與人稱",
